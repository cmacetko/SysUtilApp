...
export default function PIX() {
    ...
    const [ Campos, setCampos ] = React.useState({ Chave: "", Nome: "", Cidade: "", Valor: 0 });    
	...
	const BtnExecutar = () => {
        ...
        acoes.Executar(Campos.Chave, Campos.Nome, Campos.Cidade, Campos.Valor).then(function(RetTexto){
